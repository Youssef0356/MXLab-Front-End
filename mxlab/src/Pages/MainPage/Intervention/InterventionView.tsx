...
const InterventionView: React.FC = () => {
  ...
  const [interventions] = useState<InterventionRequest[]>([
    {
      id: '1',
      title: 'Problème moteur du convoyeur',
      description: 'Le moteur émet un bruit de broyage inhabituel pendant le fonctionnement. Site de production C',
      employee: 'Fatma',
      status: 'En Attente',
      submittedDate: '2025/05/30 en 11:30 pm',
      priority: 'Haute'
    },
    {
      id: '2',
      title: 'Courroie du convoyeur usée',
      description: 'Le moteur émet un bruit de broyage inhabituel pendant le fonctionnement. Site de production C',
      employee: 'Bachir',
      status: 'Approuvé',
      submittedDate: '2025/05/30 en 11:30 pm',
    ...
    const matchesSearch = intervention.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         ...
                         intervention.employee.toLowerCase().includes(searchTerm.toLowerCase());
            ...
            {filteredInterventions.map((intervention) => (
              <div key={intervention.id} className="grid grid-cols-12 gap-4 p-4 hover:bg-gray-50 transition-colors">
                ...
                <div className="col-span-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className={`w-3 h-3 rounded-full mt-1 ${
                      intervention.priority === 'Haute' ? 'bg-red-500' :
                ...
                <div className="col-span-2 flex items-center">
                  <span className="text-gray-900">{intervention.employee}</span>
                </div>
